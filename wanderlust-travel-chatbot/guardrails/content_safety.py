...
class ContentSafety:
    ...
    def __init__(self):
        ...
        self.unsafe_patterns = {
            'violence': ['kill', 'murder', 'attack', 'bomb', 'weapon', 'harm', 'hurt', 'terrorist'],  # HINT: List of violence-related keywords like ['kill', 'attack', etc.]
            'hate_speech': ['hate', 'discrimination', 'racist', 'sexist', 'supremacy'],  # HINT: List of hate speech keywords like
            'profanity': ['fuck', 'shit', 'damn', 'hell', 'crap'],  # HINT: List of profanity keywords
        ...
        self.travel_red_flags = ['fraud', 'fake booking', 'scam', 'stolen card', 'money laundering', 'fake claim', 'false information']  # HINT: List like ['fraud', 'fake booking', 'scam', etc.]
